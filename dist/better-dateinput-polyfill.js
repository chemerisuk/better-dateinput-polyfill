...
(function (DOM, BASE, VK_SPACE, VK_TAB, VK_ENTER, VK_ESCAPE, VK_BACKSPACE, VK_DELETE, VK_SHIFT) {
    ...
    DOM.extend("input[type=date]", {
        ...
        _changeValue: function (caption, calendarMonths, calenderDays, picker, value, prevValue) {
            ...
            if (calenderDays.every(function (days) {
                return picker.contains(days);
            })) return false;
        ...
        _clickPickerCaption: function (picker, calendarMonths, calendarDaysMain, calendarCaption, changeValue) {
            if (picker.contains(calendarMonths)) {
        ...
        _changePickerVisibility: function (picker, calendarMonths, calendarCaption, hidden) {
            if (hidden !== "true") {
                if (picker.contains(calendarMonths)) {
